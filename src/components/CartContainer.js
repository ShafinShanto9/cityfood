  ...
  return (
    <motion.div
      ...
      <div className="flex items-center justify-between w-full p-4 cursor-pointer">
        ...
        <motion.p whileTap={{scale: 0.75}} className='flex items-center gap-2 p-1 px-2 my-2 bg-red-400 rounded-md hover:shadow-md cursor-pointer text-white text-base' onClick={clearCart}>Clear Cart Items <RiRefreshFill/> </motion.p>
      </div>
    {/*  Cart Items Section */}
